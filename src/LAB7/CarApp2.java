...
//รับค่าข้อมูลของวัตถุ ฉฟพ ทั้งหมด 3 จำนวน จากผู้ใช้ พร้อมทั้งแสดงข้อมูลทั้งหมดทางหน้าจอภาพ
public class CarApp2 {
    ...
    private static void displayOpject(ArrayList<Car> myCar) {
    ...
    private static Car inputDataopject() {
        Scanner sc = new Scanner(System.in);
